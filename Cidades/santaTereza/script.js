...
const BASE_URL = "https://acist.com.br";

class AcicSantaTerezaScraper {
  constructor() {
    this.baseUrl = BASE_URL + "/associados";
  }

  async iniciarScraping() {
    console.log("🚀 Iniciando web scraping de SantaTereza");
    const empresas = [];
...
async function runAcicSantaTereza() {
  const scraper = new AcicSantaTerezaScraper();
  return await scraper.iniciarScraping();
}

module.exports = runAcicSantaTereza;
