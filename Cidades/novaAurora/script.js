...
const BASE_URL = "https://www.acinanovaaurora.com.br";

class AcinaNovaAuroraScraper {
  constructor() {
    this.baseUrl = BASE_URL + "/associados";
  }

  async iniciarScraping() {
    console.log("🚀 Iniciando web scraping da ACINA (Nova Aurora)...");
    const empresas = [];
...
async function runAcinaNovaAurora() {
  const scraper = new AcinaNovaAuroraScraper();
  return await scraper.iniciarScraping();
}

module.exports = runAcinaNovaAurora;
