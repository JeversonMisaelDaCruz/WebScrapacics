...
const BASE_URL = "https://www.acegguaraniacu.com.br/";

class AcicguaraniacuScraper {
  constructor() {
    this.baseUrl = BASE_URL + "/associados";
  }

  async iniciarScraping() {
    console.log("🚀 Iniciando web scraping de guaraniaçu");
    const empresas = [];
...
async function runAcicGuaraniacu() {
  const scraper = new AcicguaraniacuScraper();
  return await scraper.iniciarScraping();
}

module.exports = runAcicGuaraniacu;
